...
if(r)this.setVal(c);this.set_min_caption(v);},set_max:function(v,ignore)
...
if(r)this.setVal(c);this.set_max_caption(v);},set_min_caption:function(v)
{var e=$('.'+this.name+' .left-corner');e.html(this.minCaption.replace(/\{\s*0\s*\}/,v));},set_max_caption:function(v)
{var e=$('.'+this.name+' .right-corner');e.html(this.maxCaption.replace(/\{\s*0\s*\}/,v));},set_step:function(v,ignore)
